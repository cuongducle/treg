...
> **Free-stack fork.** This fork adds ten free-tier-first providers upstream had not catalogued
> (Brave Search, Google Custom Search, TwitterAPIs, SocialCrawl, SocialData, twitterapi.io,
> RedditAPIs, TikAPI, Firecrawl, official Reddit OAuth) and ships **[FREE-STACK.md](FREE-STACK.md)** —
